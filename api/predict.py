"""
Vercel serverless function — exposed at /api/predict

FastAPI `app` is the handler Vercel mounts. Routes use "/" because
the function URL already includes /api/predict.
"""
...
async def health() -> dict:
    """GET /api/predict — warm-up and health check."""
    get_agent()
...
async def predict(payload: dict) -> dict:
    """POST /api/predict — DQN inference."""
    try:
